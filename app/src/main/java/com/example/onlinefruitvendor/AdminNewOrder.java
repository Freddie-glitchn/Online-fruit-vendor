...
import com.example.onlinefruitvendor.Model.AdminOrders;
...
public class AdminNewOrder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ordersList = findViewById(R.id.new_orders_recycleView);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder> adapter = new FirebaseRecyclerAdapter<AdminOrders, AdminOrdersViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull AdminOrdersViewHolder holder, final int position, @NonNull AdminOrders model) {
                ...
                holder.userShippingAddress.setText("Delivery Address: " + model.getAddress() + model.getStreet() + model.getTown());
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        builder.setTitle("Have you shipped these fruits orders?");
    ...
    public static class AdminOrdersViewHolder extends RecyclerView.ViewHolder {
        ...
        public AdminOrdersViewHolder(@NonNull View itemView) {
            ...
            userShippingAddress = itemView.findViewById(R.id.order_address_atreet);

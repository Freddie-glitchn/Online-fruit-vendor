...
public class AdminAddNewProduct extends AppCompatActivity {
    ...
    private void ValidateProductData(){
        ...
        if (ImageUri == null){
            ...
            Toast.makeText(this, "Please indicate product Price...!", Toast.LENGTH_LONG).show();
    ...
    private void StoreProductInformation(){
        ...
        loadingBar.setMessage("Wait while we add the new product");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(AdminAddNewProduct.this,"Error: " + message, Toast.LENGTH_LONG).show();
                loadingBar.dismiss();
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                Toast.makeText(AdminAddNewProduct.this, "Image Upload successful...", Toast.LENGTH_LONG).show();
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        ...
                        if (task.isSuccessful()){
                            ...
                            Toast.makeText(AdminAddNewProduct.this, "Successfully received Image Url!", Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            ...
                            loadingBar.dismiss();
                            Toast.makeText(AdminAddNewProduct.this, "Product is added Succesfully...", Toast.LENGTH_LONG).show();
                        }else {

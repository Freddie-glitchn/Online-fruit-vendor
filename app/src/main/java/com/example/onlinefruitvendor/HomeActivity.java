...
import com.example.onlinefruitvendor.ViewHolder.ProductViewHolder;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userNameTextView.setText(Prevalent.currentOnlineListener.getName());
        Picasso.get().load(Prevalent.currentOnlineListener.getImage()).placeholder(R.drawable.profile).into(profileImageView);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_cart){
            ...
            Intent intent = new Intent(HomeActivity.this, AdminCategory.class);
            startActivity(intent);
